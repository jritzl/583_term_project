...
G = Generator(latent_dim = 100, class_dim = 10).to(device)
classifier_weights_path = '/checkpoints/models/G_40000.ckpt'  # Replace with your path
...
hair_tag = torch.zeros(80, 10).to(device)
...
z = torch.randn(80, 100).to(device)
